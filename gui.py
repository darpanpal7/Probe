...
class TopLevel:
    ...
    #___________________________________________________________________________________________________
        ...
        self.Canvas1.place(relx=0.0, rely=0.058, relheight=0.879, relwidth=0.998)
    ...
    #___________________________________________________________________________________________________
        ...
        self.Text1.place(relx=0.007, rely=0.05, relheight=0.905, relwidth=0.982)
    ...
    #___________________________________________________________________________________________________
        ...
        self.SearchEntry.place(relx=0.007, rely=0.015, height=20, relwidth=0.772)
...
#------------------------------------------------------------------------------------------------------
    ...
    def create_items(self,file_list) :
        ...
        for each in file_list :
            b = tk.Button(self.Text1, text="%s" % each) #adding text to button
            b.pack(side=tk.LEFT)
            b.configure(relief="flat")
            b.configure(command = lambda x = each : self.startfile(x)) #command to startfile
    ...
    def search(self) :
        ...
        labelstring = "Total Files : " + str(total_files) + ",     Total Time : " + str(total_time)
